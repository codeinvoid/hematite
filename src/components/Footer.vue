<template>
    <section id="footer" class=" section">
        <footer class="absolute bg-ff5c5c right-0 left-0 b-0 fw900">
                ...
                <div class="padding-1vw sm:padding-auto">
                    <div class="w60 md:mb-25px mr-10 float-left">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -200 780.72 200.16">
                            <path class="cls-1" d="M109.3,117.3V54.7h25.5c3.3,0,6.5,0.8,9.3,2.5c2.8,1.7,5.1,4.1,6.6,6.9c3.3,6.1,3.3,13.4,0,19.5c-1.6,2.8-3.9,5.3-6.6,7c-2.8,1.8-6,2.7-9.2,2.6h-15.8v24L109.3,117.3z M118.9,84h15.6c1.6,0,3.1-0.5,4.4-1.4c1.3-0.9,2.4-2.2,3.2-3.6c0.8-1.5,1.2-3.3,1.2-5c0-1.7-0.4-3.5-1.2-5c-0.8-1.4-1.8-2.7-3.2-3.6c-1.3-0.9-2.8-1.4-4.4-1.4h-15.6V84z"/>
                            <path class="cls-1" d="M163.6,117.3V70.3h9.3v14.7l-0.9-3.6c0.7-2.3,1.8-4.4,3.4-6.2c1.5-1.8,3.4-3.3,5.4-4.3c2-1,4.2-1.6,6.4-1.6
                            ...
                            <path class="cls-1" d="M372.5,79.3v-8.9h29.9v8.9H372.5z M382.3,117.3V58.4h9.2v58.9L382.3,117.3z"/>
                            ...
                            <ellipse transform="matrix(0.1602 -0.9871 0.9871 0.1602 163.8939 300.5942)" class="cls-2" cx="258.6" cy="54" rx="6.4" ry="6.4"/>
                        </svg>
                    </div>
                    <div class="float-left mb-25px md:font-size-18px sm:md:font-size-18px font-size-25px">
                        <nav>
                            <ul md:m4 ml-0>
                                <li class="c-white md:text-center float-left mr-30 md:mb-10 mb-5 text-left ml-0">
                                    分社
                                    <ul class="d-block md:text-center ps-0 md:font-size-16px font-size-20px text-left ml-0">
                                        <li class="d-block w-a m-5"><a href="/anime" data-turbo-action="replace">动画</a></li>
                                        <li class="d-block w-a m-5"><a href="/game" data-turbo-action="replace">游戏</a></li>
                                    </ul>
                                </li>
                                <li class="c-white md:text-center float-left mr-30 md:mb-10 mb-5 text-left ml-0">
                                    文档
                                    <ul class="d-block ps-0 md:text-center md:font-size-16px sm:font-size-16px font-size-20px text-left ml-0">
                                        <li class="w-a m-5"><a href="/api" data-turbo-action="replace">接口</a></li>
                                        <li class="w-a m-5"><a href="https://wiki.pkgho.com" target="_blank" data-turbo-action="replace">维基</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
            ...
            <div float-left b-0 absolute ml-70px fw-300 overflow-hidden>
                <p class="color-white">ProjectRTSN/hematite&nbsp;{{branch}}@<a :href=git_link target="_blank" data-turbo-action="replace">{{hash_short}}</a></p>
            </div>
        </footer>
    </section>
</template>
...
.cls-1 {fill:#FFF;}
.cls-2 {fill:#FFF;transform:translateY(-70%)}
</style>